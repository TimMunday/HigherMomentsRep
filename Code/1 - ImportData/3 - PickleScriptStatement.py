...
This script takes the excel files for the statements said before the Q and A
...
ir_dates.drop(ir_dates.index[71:], axis=0, inplace=True) # only keep those in 2001
...
data.rename(columns = {'Date':'LookUpDate',
                       'Title':'Section'}, inplace=True) # rename Date column to not get confused

data.to_pickle('Data/Pickled/Statement.pkl')